...
fluid.registerNamespace("gpii.test.couchdb.cushion.loopbackMiddleware");

gpii.test.couchdb.cushion.loopbackMiddleware.middleware = function (that, request, response) {
...
fluid.defaults("gpii.test.couchdb.cushion.loopbackMiddleware", {
    ...
    invokers: {
        middleware: {
            funcName: "gpii.test.couchdb.cushion.loopbackMiddleware.middleware",
